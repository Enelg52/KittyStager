...
// Modifed version of https://gist.github.com/leoloobeek/c726719d25d7e7953d4121bd93dd2ed3
...
func DllToShellcode(dllBytes []byte, functionName string) ([]byte, error) {
	...
	shellcode := convertToShellcode(dllBytes, hashFunction)
	return shellcode, nil

}

func convertToShellcode(dllBytes, functionHash []byte) []byte {
	...
	if is64BitDLL(dllBytes) {
		...
		// Set up the location of our user data
